...
function isGender(inputtxt) {
  if(inputtxt.toLowerCase() === "male" || inputtxt.toLowerCase() === "female"  ) {
    return true;
  }
  else {
    return false;
...
module.exports = {isPhonenumber , isAddress, isAadhar, isPassword, isGstNo, isBankAccNo, isIfsc, isName, isEmail, isGender}